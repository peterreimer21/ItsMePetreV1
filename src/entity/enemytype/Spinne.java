...
public class Spinne extends Gegner {
	...
	public Spinne(TileMap tileMap) {
		super(tileMap);

		bewegGeschwindigkeit = 0.4;
		maximaleGeschwindigkeit = 0.4;
		...
		// Sprites laden
		try {
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/Sprites/Enemies/spinne.gif"));
